...
OUTDIR = ROOT / "progetto" / "risultati" / "qfpuf" / "presentazione"
...
def _matrix(config, seeds, profile, *, use_bc=False):
    """Costruisce la matrice (enrolled,executed) -> score. Ritorna dict + ideals."""
...
def main():
    config = load_config(ROOT / "progetto" / "qfpuf_config.json")
